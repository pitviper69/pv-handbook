...
- **`color`**
  ...
  Options: 
  <span class="bg-Pink bg-base-300 p-1 border rounded text-sm font-semibold">"Pink"</span>
  <span class="bg-Purple bg-base-300 p-1 border rounded text-sm font-semibold">"Purple"</span>
  <span class="bg-Red bg-base-300 p-1 border rounded text-sm font-semibold">"Red"</span>
  <span class="bg-Orange bg-base-300 p-1 border rounded text-sm font-semibold">"Orange"</span>
  <span class="bg-Yellow bg-base-300 p-1 border rounded text-sm font-semibold">"Yellow"</span>
  <span class="bg-success bg-base-300 p-1 border rounded text-sm font-semibold">"Green"</span>
  <span class="bg-Teal bg-base-300 p-1 border rounded text-sm font-semibold">"Teal"</span>
  <span class="bg-Sky bg-base-300 p-1 border rounded text-sm font-semibold">"Sky"</span>
  <span class="bg-Blue bg-base-300 p-1 border rounded text-sm font-semibold">"Blue"</span>
